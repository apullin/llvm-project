...
; CHECK-NEXT:    INX H
; CHECK-NEXT:    MOV M, A
; CHECK-NEXT:    JNC LBB2_6
; CHECK-NEXT:  LBB2_2:
; CHECK-NEXT:    MVI A, 0
; CHECK-NEXT:    ORI 0
; CHECK-NEXT:    JZ LBB2_7
; CHECK-NEXT:  LBB2_3:
; CHECK-NEXT:    MVI A, 0
...
; CHECK-NEXT:    MOV A, C
; CHECK-NEXT:    ORI 0
; CHECK-NEXT:    JNZ LBB4_16
; CHECK-NEXT:  LBB4_18:
; CHECK-NEXT:    MVI A, 1
; CHECK-NEXT:    JMP LBB4_19
; CHECK-NEXT:  LBB4_16:
; CHECK-NEXT:    MVI A, 0
; CHECK-NEXT:  LBB4_19:
; CHECK-NEXT:    LXI H, 16
