...
// RUN: %S/../../../../../i8085-trace/build/i8085-trace -S -q -n 200000 --irq=75@50000 \
// RUN:   -d 0x0500:0x03 %t.bin 2>&1 | FileCheck %s --check-prefix=RST75
...
// RST75: Memory dump 0x0500 - 0x0502 (3 bytes):
// RST75: 0500: 11 55 22
// RST75: "halt":"hlt"
