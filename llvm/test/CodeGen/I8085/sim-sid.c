...
// RUN: %S/../../../../../i8085-trace/build/i8085-trace -S -q -n 200000 --sid=1 -d 0x0320:0x01 %t.bin 2>&1 | FileCheck %s --check-prefix=SID

__attribute__((naked)) int main(void) {
  __asm__ volatile("rim\n"
                   "sta 0x0320\n"
                   "ret\n");
}

// SID: Memory dump 0x0320 - 0x0320 (1 bytes):
// SID: 0320: 80
// SID: "halt":"hlt"
